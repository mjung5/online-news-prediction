...
g5 <- ggplot(data = df, aes(x =  num_imgs, 
                      y = shares)) +
      geom_point(alpha = 0.50) + geom_smooth(formula = 'y ~ x', method = 'loess')+
  #theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
      ggtitle("Word count in the content")
g5
```
...
```{r}
#scatter plots of Number of words in the content
g7 <- ggplot(data = df, aes(x =  num_keywords, 
                      y = shares)) +
      geom_point(alpha = 0.50) + geom_smooth(formula = 'y ~ x', method = 'loess')+
  #theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
      ggtitle("Word count in the content")
...
```{r}
#scatter plots of Number of words in the content
g8 <- ggplot(data = df, aes(x =  rate_positive_words, 
                      y = shares)) +
      geom_point(alpha = 0.50) + geom_smooth(formula = 'y ~ x', method = 'loess')+
  #theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
      ggtitle("Word count in the content")
...
```{r}
#scatter plots of Number of words in the content
g9 <- ggplot(data = df, aes(x =     abs_title_subjectivity, 
                      y = shares)) +
      geom_point(alpha = 0.50) + geom_smooth(formula = 'y ~ x', method = 'loess')+
  #theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
      ggtitle("Word count in the content")
...
```{r}
set.seed(10)
lrm.fit1 <- train(shares ~ n_tokens_title + n_tokens_content+ n_unique_tokens+avg_positive_polarity+  num_hrefs+  num_imgs+ num_videos+num_keywords+title_sentiment_polarity+ avg_negative_polarity+ rate_positive_words+rate_negative_words+  title_subjectivity  + I(n_tokens_title^2) , data = trainData,
