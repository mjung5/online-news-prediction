...
```
    ...
    ## 
    ##   RMSE      Rsquared    MAE     
    ##   7415.368  0.01257086  2499.888
    ## 
    ## Tuning parameter 'intercept' was held constant at a value of TRUE

First linear model has an RMSE of 7415.37.
...
```
    ...
    ## Summary of sample sizes: 4115, 4113, 4113, 4115, 4112 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared    MAE     
    ##   8192.796  0.01686551  2434.248
    ## 
    ## Tuning parameter 'mtry' was held constant at a value of 1

The random forest model has an RMSE of 8192.8.
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (5 fold) 
    ## Summary of sample sizes: 4114, 4115, 4113, 4112, 4114 
    ## Resampling results:
    ## 
    ##   RMSE     Rsquared    MAE     
    ##   8270.22  0.02204281  2408.592
    ## 
...
The boosted tree model has an RMSE of 8270.22.
...
|                           |    RMSE |
|:--------------------------|--------:|
| Linear.Regression.Model.1 | 4004.01 |
| Linear.Regression.Model.2 | 4891.18 |
| Random.Forest.Model       | 3902.55 |
| Boosting.Model            | 4007.17 |
...
The winning model is Random Forest. Its RMSE value is 3902.55.
