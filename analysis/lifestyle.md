...
```
    ...
    ## 
    ##   RMSE      Rsquared     MAE     
    ##   9052.817  0.006367913  3674.934
    ## 
    ## Tuning parameter 'intercept' was held constant at a value of TRUE

First linear model has an RMSE of 9052.82.
...
```
    ...
    ## Summary of sample sizes: 1175, 1176, 1175, 1175, 1175 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared     MAE     
    ##   9812.679  0.002969621  3621.299
    ## 
    ## Tuning parameter 'mtry' was held constant at a value of 1

The random forest model has an RMSE of 9812.68.
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (5 fold) 
    ## Summary of sample sizes: 1175, 1174, 1176, 1175, 1176 
    ## Resampling results:
    ## 
    ##   RMSE     Rsquared     MAE   
    ##   9614.25  0.008591569  3594.9
    ## 
...
The boosted tree model has an RMSE of 9614.25.
...
|                           |    RMSE |
|:--------------------------|--------:|
| Linear.Regression.Model.1 | 4886.88 |
| Linear.Regression.Model.2 | 5804.90 |
| Random.Forest.Model       | 4784.69 |
| Boosting.Model            | 4946.42 |
...
The winning model is Random Forest. Its RMSE value is 4784.69.
